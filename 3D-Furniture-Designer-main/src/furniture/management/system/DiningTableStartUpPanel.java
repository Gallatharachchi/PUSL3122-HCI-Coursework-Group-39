...
public class DiningTableStartUpPanel extends JPanel {
    public DiningTableStartUpPanel(JPanel contentPanel, CardLayout cardLayout) {
        ...
        JLabel titleLabel = new JLabel("Customize Your Dining Table");
        ...
        JLabel descriptionLabel = new JLabel("Select a design mode to personalize your dining table to match your space and style.");
        ...
        button2d.addActionListener(e -> cardLayout.show(contentPanel, "diningTableDisplay2d"));

        JButton button3d = createRoundedBlueButton("Start in 3D");
        button3d.addActionListener(e -> cardLayout.show(contentPanel, "diningTableDisplay"));
